 ...
 */
final class Version20230220140529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicules ADD imagesvh VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE rendezvous_utilisateur (rendezvous_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_A9237ED33345E0A3 (rendezvous_id), INDEX IDX_A9237ED3FB88E14F (utilisateur_id), PRIMARY KEY(rendezvous_id, utilisateur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE vehicules DROP imagesvh');
    }
}

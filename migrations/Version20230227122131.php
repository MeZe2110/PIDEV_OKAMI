 ...
 */
final class Version20230227122131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendezvous_utilisateur ADD CONSTRAINT FK_A9237ED33345E0A3 FOREIGN KEY (rendezvous_id) REFERENCES rendezvous (id)');
    }
